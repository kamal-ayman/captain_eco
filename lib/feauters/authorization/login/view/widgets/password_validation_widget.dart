import 'package:captain_eco/core/helpers/spacing.dart';
  ...
  Widget buildValidationRow(String text, bool hasValidated) {
    return Row(
      children: [
        const CircleAvatar(
          radius: 2.5,
          backgroundColor: LightColorsManager.grey,
        ),
        widthSpace(6),
        Text(
          text,
          style: TextStyles.black13regular.copyWith(
            ...
            color: hasValidated ? LightColorsManager.grey : LightColorsManager.black,
          ),
        )
      ],
    );
